...
b8 platform_system_startup(
    ...
    *memory_requirement = sizeof(platform_state);
    ...
    wc.lpszClassName = "fuse_window_class";
    ...
    HWND handle = CreateWindowExA(
        window_ex_style, "fuse_window_class", application_name,
    ...
    DwmSetWindowAttribute(state_ptr->hwnd, DWMWA_USE_IMMERSIVE_DARK_MODE, &value, sizeof(value));
